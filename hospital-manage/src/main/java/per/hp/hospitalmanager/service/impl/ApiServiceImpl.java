package per.hp.hospitalmanager.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import per.hp.hospitalmanager.mapper.HospitalSetMapper;
import per.hp.hospitalmanager.mapper.ScheduleMapper;
import per.hp.hospitalmanager.model.HospitalSet;
import per.hp.hospitalmanager.model.Schedule;
import per.hp.hospitalmanager.service.ApiService;
import per.hp.hospitalmanager.util.BeanUtils;
import per.hp.hospitalmanager.util.HttpRequestHelper;
import per.hp.hospitalmanager.util.YyghException;
